...
- `.claude/modeling/principles/discovering-actors.md` -- "Goals are conditional," the derivation chain, and why value conditions drive system design
...
- `.claude/modeling/principles/discovering-actors.md` -- "Goal conditions create tensions; tensions spawn supporting actors," "Goal conflicts spawn actors," "Single responsibility for actors"
...
- `.claude/modeling/principles/grounding-models.md` -- "Extract, don't invent"
