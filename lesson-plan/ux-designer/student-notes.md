...
- `.claude/guidance/usecase-philosophy.md` -- "Goals are conditional," "Value conditions drive the entire system design"
...
- `.claude/guidance/usecase-philosophy.md` -- "Goal conditions create tensions; tensions spawn supporting actors," "Goal conflicts spawn actors," "Single responsibility for actors"
...
- `.claude/guidance/usecase-philosophy.md` -- "Extract, don't invent"
