...
- `actor.md` -- "Goals are conditional," the derivation chain, and why value conditions drive system design
...
- `actor.md` -- "Goal conditions create tensions; tensions spawn supporting actors," "Goal conflicts spawn actors"
