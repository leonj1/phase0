...
Behavioral contract for durable capture during discovery work. Ensures that every discovery — refinement, new artifact, or loose observation — is written to file in the turn it occurs. Load when an agent conducts interviews, models artifacts, or explores a domain.
