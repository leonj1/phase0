...
model: opus
memory: project
skills: [grounding-models, modeling-usecases, navigating-models, authoring-actors, authoring-catalogs, authoring-usecases, authoring-events, authoring-invariants, authoring-notes, authoring-todos, preserving-discoveries, enforcing-style]
---
